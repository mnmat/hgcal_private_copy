...
process.FEVTDEBUGHLTEventContent.outputCommands.append('keep *_hltOnlineBeamSpot_*_*')
process.FEVTDEBUGHLTEventContent.outputCommands.append('keep *_offlineBeamSpot_*_*')
...
process.FEVTDEBUGHLTEventContent.outputCommands.append('keep *_hgcalMergeLayerClusters_*_*')
...
process = customiseTICLForKalmanFilterNtuplizer(process)
process = customiseTICLForKalmanFilterMetricAnalyzer(process)
process.FEVTDEBUGHLToutput_step = cms.EndPath(process.FEVTDEBUGHLToutput + process.kfNtuplizer + process.kfAnalyzer)

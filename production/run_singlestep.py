...
parser.add_argument('--nevents', help = "Number of events", choices = ['1', '500', '10000', 'all'], type=str, nargs='+')
      ...
      for nevent in nevents:
        for cap in caps:
          ...
          for en in energies:
            ...
            command = "cmsRun step1_%s.py %s %s %s %s %s %s"%(genProducer[sample], en, eta, sample, nevent, cap, outFolder)
        ...
        for nevent in nevents:
          for cap in caps:
            ...
            for en in energies:
              ...
              command = "cmsRun %s.py %s %s %s %s %s %s %s"%(config_name, en, eta, sample, nevent, cap, inFolder, outFolder)
